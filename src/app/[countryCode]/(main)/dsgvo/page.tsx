...
const dsgvo: React.FC = () => {
  return (
    <div className=" mx-auto max-w-7xl px-4 sm:px-6 lg:px-12  pb-12 pt-12">
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-semibold mb-4">5. Zahlungsanbieter</h2>
        <h3 className="text-xl font-semibold mb-2">PayPal</h3>
        <p>Auf unserer Website bieten wir u.a. die Bezahlung via PayPal an. Anbieter dieses Zahlungsdienstes ist die PayPal (Europe) S.à.r.l. et Cie, S.C.A., 22-24 Boulevard Royal, L-2449 Luxembourg.</p>
        <p>Wenn Sie mit PayPal bezahlen, erfolgt eine Übermittlung der von Ihnen eingegebenen Zahlungsdaten an PayPal.</p>
      </section>
      
      <section className="mb-8">
        <h2 className="text-2xl font-semibold mb-4">6. Online-Marketing und Partnerprogramme</h2>
        <h3 className="text-xl font-semibold mb-2">Amazon Partnerprogramm</h3>
        <p>Die Betreiber der Seiten nehmen am Amazon EU- Partnerprogramm teil. Auf unseren Seiten werden durch Amazon Werbeanzeigen und Links zur Seite von Amazon.de eingebunden, an denen wir über Werbekostenerstattung Geld verdienen können.</p>
      </section>
      
      <section className="mb-8">
        <h2 className="text-2xl font-semibold mb-4">7. Ihre Rechte als betroffene Person</h2>
      ...
      <section>
        <h2 className="text-2xl font-semibold mb-4">8. Änderung unserer Datenschutzbestimmungen</h2>
