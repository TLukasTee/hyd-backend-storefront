...
export default async function CollectionVital({
  sortBy,
  collection,
  page,
  countryCode,
  ...
  const vitalstoffeProductIds = [
    "prod_01J35N6KEVJ70QEAVA7KMHTTFS",
    "prod_01J35NZ7QJP7ZF4X4GGG5MP5E8",
    // Hydro Whey
  ...
  return (
    <div className=" mx-auto max-w-7xl px-7 sm:static sm:px-6 lg:px-10"> 
       ...
       <RefinementList sortBy={sortBy || "created_at"} />
        ...
        <ProteinProducts collections={collections} region={region} specificProductIds={vitalstoffeProductIds} />
        </Suspense>
