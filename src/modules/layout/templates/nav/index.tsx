              ...
              {process.env.FEATURE_SEARCH_ENABLED && (
                ...
                >
                  <div className="flex items-center w-full">
                    ...
                    <input
                      type="text"
                      placeholder="Suche nach Protein, Vitalstoffen..."
                      className="w-full py-2 pl-10 pr-3 text-sm text-gray-700 bg-white border border-gray-300 rounded-full focus:outline-none focus:ring-2 focus:ring-gray-300 focus:border-transparent"
                      readOnly
                    />
                  </div>
                </LocalizedClientLink>
