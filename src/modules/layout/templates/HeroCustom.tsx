      ...
      <div className="pb-80 pt-10 sm:pb-40 sm:pt-14 lg:pb-56 lg:pt-14  ">
        <div className="relative mx-auto max-w-7xl px-7 sm:static sm:px-6 lg:px-8">
          <div className="sm:max-w-xl">
            ...
            <div className="sm:ml-2  lg:ml-0 inline-flex">
              <div className='inline-flex'>
                <Image
                  ...
                  alt=""
                />
                <span className={`${Beba.className} sm:text-3xl text-xl tracking-wider text-black uppercase sm:ml-2 ml-1 mt-0.5 sm:mt-3.5 font-bold`}>Nutrition | ÖSTERREICH</span>
          ...
          <div>
            <div className="mt-10">
                    ...
                    <div className="grid flex-shrink-0 grid-cols-1 gap-y-6 lg:gap-y-8">
                      <div className="overflow-hidden rounded-lg sm:opacity-0 lg:opacity-100 sm:max-w-3xl max-w-xl sm:mt-12 pt-24 sm:pt-0 pr-36">
                        <Image
                          ...
                          alt=""
                          className="h-full w-full object-cover object-center max-[375px]:pr-24 max-[375px]:pt-16 min-[390px]:pt-0 min-[390px]:pr-0"
                        />
                      </div>
              ...
              <Link
                href="/store"
                className="inline-block mr-4 border border-transparent uppercase  bg-red-600 px-8 py-3 text-center font-medium  rounded-full text-white hover:bg-red-700 transition-all"
              >
                ZUM Sortiment
              </Link>
