...
import ProductPage from "./accordion"
import ProductNutritions2 from "./accordion"
...
const ProductTemplate: React.FC<ProductTemplateProps> = ({
  ...
  return (
    <>
      ...
      <div className="flex flex-col md:flex-row mx-auto max-w-7xl pb-10 border-b-2 border-gray-100 ">
      ...
      <div className="bg-gray-50  px-6 sm:px-6 lg:px-8 py-6  ">
      ...
      <ProductNutritions2  product={product} countryCode={countryCode} />
